	...
	protected override void Up(MigrationBuilder migrationBuilder)
	{
		...
		migrationBuilder.CreateTable(
			...
			table => new
			{
				...
				Title = table.Column<string>("TEXT", maxLength: 20, nullable: false),
				RefreshToken = table.Column<string>("TEXT", maxLength: 64, nullable: true),
				RefreshTokenExpiryTime = table.Column<DateTime>("TEXT", nullable: true),
